<template>
    <div class="main">
      <div class="info">
          <h4><img  src="/storage/newimage/phone.png"> Телефон: +38(068)-00-00-000</h4>
          <h4><img  src="/storage/newimage/telegram_icon.png"> Telegram: +38(068)-00-00-000</h4>
          <h4><img  src="/storage/newimage/viber_icon.png"> Viber: +38(068)-00-00-000</h4>
          <h4><img  src="/storage/newimage/whatsapp_socialnetwork_17360.png"> WhatsApp: +38(068)-00-00-000</h4>
    ...
    methods:{
        ...
        sendMessageFromUser:function (){
            if(this.newMessage.length===0 || this.messageFrom.length===0){
                alert('Пустое или анонимное сообщение не отправляется');
                this.modalWindow=false;
            }
