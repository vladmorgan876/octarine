            ...
            <div class="col-md-8">
                <div>
                    ...
                    <div  class="productsINcatalog">
                        ...
                        <div  id="zoomPicture" class="zoomPicture"><img v-bind:src="'/storage/'+this.pictureZoom">
                            <div  v-on:click="closePicture($event)" class="close-btn" >&times</div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods:{
        zoom:function (image){
            this.pictureZoom=image;
            debugger;
            document.getElementsByClassName("zoomPicture")[0].style.display="block";
        },
        closePicture:function (event){
